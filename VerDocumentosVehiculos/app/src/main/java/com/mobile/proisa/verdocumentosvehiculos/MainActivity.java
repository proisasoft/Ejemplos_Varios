package com.mobile.proisa.verdocumentosvehiculos;
...
import com.mobile.proisa.fotosvehiculoslibrary.Actividades.VerDocumentosActivity;
import com.mobile.proisa.fotosvehiculoslibrary.Actividades.VerFotosActivity;
...
public class MainActivity extends AppCompatActivity implements  VehiculoViewAdapter.OnItemClickListener, OnTapListener<Vehiculo>, TareaAsincrona.OnFinishedProcess, FiltroFragment.SearchListener {
    ...
    public void buscarVehiculos(String filter){
        lastFilter = filter;
    ...
    public void onItemClick(Vehiculo v, int posicion) {
        Intent intent = new Intent(getApplicationContext(), VerDocumentosActivity.class);
        ...
        switch (requestCode){
            case REQUEST_CODE_MEMORY:
                if (grantResults.length > 0  && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getApplicationContext(), com.mobile.proisa.fotosvehiculoslibrary.R.string.permiso_memoria_denegado,Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
