...
import com.mobile.proisa.agregarfotosvehiculo.Adaptadores.RecyclerViewAdapter;
import com.mobile.proisa.agregarfotosvehiculo.Clases.MyMediaScanner;
...
public class GalleryFragment extends Fragment implements RecyclerViewAdapter.OnItemClickListener {
    ...
    public void onItemClick(final Uri uri, int posicion) {
        ...
        builder.setMessage("¿Qué desea hacer con esta imagén?");

        builder.setPositiveButton("Ampliar", new DialogInterface.OnClickListener() {
            @Override
