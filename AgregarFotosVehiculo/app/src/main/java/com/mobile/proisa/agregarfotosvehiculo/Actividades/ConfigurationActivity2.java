package com.mobile.proisa.agregarfotosvehiculo.Actividades;
...
public class ConfigurationActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mobile.proisa.fotosvehiculoslibrary.R.layout.activity_configuration);
        enlazarUI();
        dialogEntrar();
    }
    ...
    private void setInfo(){
        datosBd = MetodosEstaticos.obtenerPreferenciasBaseDeDatos(getSharedPreferences(Constantes.PREFERENCES_DATA_BASE_2,MODE_PRIVATE));
    ...
    private void savePreferences(String pass){
        SharedPreferences preferences = getSharedPreferences(Constantes.PREFERENCES_DATA_BASE_2,MODE_PRIVATE);
