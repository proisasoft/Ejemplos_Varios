...
import com.mobile.proisa.fotosvehiculoslibrary.Procesos.ProcesoSubirDocumentos;
...
public class AgregarDocumentosActivity extends AppCompatActivity implements View.OnClickListener, TareaAsincrona.OnFinishedProcess{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.action_add) {
            ...
            if(mVehiculo.hasFotos()){
                new ProcesoSubirDocumentos(ID_VEHICULO_IMAGENES_SUBIR,this,this, mVehiculo).execute();
            }
        }
